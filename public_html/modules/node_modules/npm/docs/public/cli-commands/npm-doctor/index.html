...
– especially on Windows – you may have Git set up in such a way that it's not
...
get cache</code>, and see what's in that cache with <code class="language-text">npm cache ls</code> – probably more
